...
WebUI.click(findTestObject('Object Repository/Page_About Us  Fit by Beat/h1_About Us'))

WebUI.click(findTestObject('Object Repository/Page_About Us  Fit by Beat/h2_The first project'))
